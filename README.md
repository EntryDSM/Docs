# EntryDSM-API OpenAPI Specification
[![Build Status](https://travis-ci.com/EntryDSM/docs.svg?branch=master)](https://travis-ci.com/EntryDSM/docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://entrydsm.github.io/docs/)
- [SwaggerUI](https://entrydsm.github.io/docs/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://entrydsm.github.io/docs/openapi.json) [YAML](https://entrydsm.github.io/docs/openapi.yaml)
